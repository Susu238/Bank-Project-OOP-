...
private:
    ...
    static stTransferLogRecord _ConvertTransferLogLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        stTransferLogRecord.DateTime = vTransferLogRecordLine[0];
        stTransferLogRecord.SourceAccountNumber = vTransferLogRecordLine[1];
        stTransferLogRecord.DestinationAccountNumber = vTransferLogRecordLine[2];
        stTransferLogRecord.Amount = stod(vTransferLogRecordLine[3]);
        stTransferLogRecord.srcBalanceAfter = stod(vTransferLogRecordLine[4]);
        stTransferLogRecord.destBalanceAfter = stod(vTransferLogRecordLine[5]);
        stTransferLogRecord.UserName = vTransferLogRecordLine[6];
